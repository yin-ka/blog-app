...
RSpec.describe 'Posts', type: :request do
  describe 'GET' do
    before :all do
      @user1 = User.create(name: 'Yusuf Sholotan', photo: 'https://myphotos.com',
    ...
    describe '/posts#index' do
      ...
      it 'should include the correct placeholder text' do
        expect(response.body).to include('Hello List of posts will appear here')
      end
    end
    ...
    describe '/posts#show' do
      ...
      it 'should include the correct placeholder text' do
        expect(response.body).to include('Hello Selected post detail will appear here')
      end
    end
  end
end
