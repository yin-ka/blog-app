...
RSpec.describe 'Users', type: :system, js: true do
  before(:all) do
    ...
    @post2 = Post.create(title: 'The Art of Acting', text: 'Dedicated to my craft and the art of acting.', author: @streep)
    @post3 = Post.create(title: 'Working for Change', text: 'Striving to make a positive impact on the world.', author: @obama)
    @post4 = Post.create(title: 'Iconic Movie Roles', text: 'Exploring the memorable characters I\'ve portrayed.', author: @streep)
  end
